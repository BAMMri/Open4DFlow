...
A demo notebook with example data is available: [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)]([XX](https://colab.research.google.com/drive/1KA2dQRTU1l7U4Darnd9UKPh657nCDPp5#scrollTo=Q05HA9ElTfg6)) — data is fetched automatically from [Zenodo].

## Pipeline Scripts

- **`reconstruct_and_process.py`** – Converts raw ISMRMRD data to BART format, performs ESPIRiT coil sensitivity estimation and compressed sensing reconstruction per venc and cardiac phase (with optional joint reconstruction and GPU acceleration), computes phase-difference velocities, and saves the result in [ORMIR-MIDS](https://github.com/ORMIR-MIDS/ORMIR_MIDS) NIfTI format.
